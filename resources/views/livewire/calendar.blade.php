<div>
    ...
    <input type="text" id="calendar" class="block mt-1 mb-2 mx-auto" name="calendar" value="{{ $currentDate }}"
            ...
            <div class="w-32">
                ...
                @for ($j = 0; $j < 21; $j++)
                    @if ($events->isNotEmpty())
                        <div class="py-1 px-2 h-8 border border-gray-200 text-center">{{ \Constant::EVENT_TIME[$j] }}
                        </div>
                    @else
